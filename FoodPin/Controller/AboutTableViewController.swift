...
class AboutTableViewController: UITableViewController {
    ...
    var sectionContent = [[(image: "store", text: NSLocalizedString("Rate us on App Store", comment: "Rate us on App Store"), link: "https://www.apple.com/ios/app-store/"),
                          ...
                          [(image: "twitter", text: NSLocalizedString("Twitter",comment: "Tell us your feedback"),link: "https://twitter.com/appcodamobile"),
                           (image: "facebook", text: NSLocalizedString("Facebook",comment: "Tell us your feedback"), link: "https://facebook.com/appcodamobile"),
                           (image: "instagram", text: NSLocalizedString("Instagram", comment: "Tell us your feedback"), link: "https://www.instagram.com/appcodadotcom")]]
