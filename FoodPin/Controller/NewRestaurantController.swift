...
class NewRestaurantController: UITableViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    // This code assigns the imageView with the selected image
    // This code sets the constraints of imageView programmatically
    ...
    @IBAction func saveButtonTapped(sender: AnyObject) {
        ...
        if nameTextField.text == "" || typeTextField.text == "" || addressTextField.text == "" || phoneTextField.text == "" || descriptionTextView.text == "" {
            let alertController = UIAlertController(title: "Oops", message: NSLocalizedString("We can't proceed because one of the fields is blank. Please note that all fields are required.", comment: "Fields shouldn't be blank"), preferredStyle: .alert)
